...
import { AssignmentSortOption, AssignmentState, SortDirection } from "@/types/enums";
...
export default function EditAssignment() {
    ...
    const onSubmit = async (data: AssignmentDetailUpdateForm) => {
        ...
        try {
            ...
            // Ensure when navigating back, the list is refreshed based on the updated at
            setSortBy(AssignmentSortOption.UPDATED_AT);
    ...
    if (assignmentDetail.data.assignment.assignment_state !== AssignmentState.WAITING_FOR_ACCEPTANCE) {
        return (
            <PageLayout title="Edit Assignment">
                <div className="alert alert-warning">
                    <span>This assignment can no longer be edited.</span>
                </div>
            </PageLayout>
        );
    }
